...
.method protected constructor <init>()V
    ...
    .line 43
    iput-boolean v8, p0, Lorg/xbill/DNS/spi/DNSJavaNameService;->preferV6:Z

    .line 55
    const-string v8, "sun.net.spi.nameservice.nameservers"
    ...
    .line 56
    .local v3, "nameServers":Ljava/lang/String;
    const-string v8, "sun.net.spi.nameservice.domain"
    ...
    const-string v8, "java.net.preferIPv6Addresses"
    ...
    invoke-direct {v4, v5}, Lorg/xbill/DNS/ExtendedResolver;-><init>([Ljava/lang/String;)V

    .line 67
    .local v4, "res":Lorg/xbill/DNS/Resolver;
    ...
    .line 75
    .end local v1    # "n":I
    .end local v4    # "res":Lorg/xbill/DNS/Resolver;
    ...
    invoke-static {v8}, Lorg/xbill/DNS/Lookup;->setDefaultSearchPath([Ljava/lang/String;)V
    :try_end_1
    ...
    .line 86
    iput-boolean v10, p0, Lorg/xbill/DNS/spi/DNSJavaNameService;->preferV6:Z
    ...
    .restart local v5    # "servers":[Ljava/lang/String;
    ...
    const-string v9, "DNSJavaNameService: invalid sun.net.spi.nameservice.domain"
...
.method public lookupAllHostAddr(Ljava/lang/String;)[Ljava/net/InetAddress;
    ...
    invoke-direct {v4, p1}, Lorg/xbill/DNS/Name;-><init>(Ljava/lang/String;)V
    :try_end_0
    ...
    .line 140
    .local v5, "records":[Lorg/xbill/DNS/Record;
    iget-boolean v6, p0, Lorg/xbill/DNS/spi/DNSJavaNameService;->preferV6:Z
    ...
    invoke-direct {v6, v4, v8}, Lorg/xbill/DNS/Lookup;-><init>(Lorg/xbill/DNS/Name;I)V
    ...
    invoke-direct {v6, v4, v7}, Lorg/xbill/DNS/Lookup;-><init>(Lorg/xbill/DNS/Name;I)V
    ...
    .line 136
    .end local v4    # "name":Lorg/xbill/DNS/Name;
    .end local v5    # "records":[Lorg/xbill/DNS/Record;
    :catch_0
    move-exception v6
    ...
    .line 149
    .restart local v4    # "name":Lorg/xbill/DNS/Name;
    .restart local v5    # "records":[Lorg/xbill/DNS/Record;
    :cond_3
    array-length v6, v5

    new-array v2, v6, [Ljava/net/InetAddress;
    ...
    instance-of v6, v6, Lorg/xbill/DNS/ARecord;
