.class public Lcom/umeng/socialize/controller/impl/BaseController;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/umeng/socialize/controller/impl/BaseController;->g:I
...
.method public constructor <init>(Lcom/umeng/socialize/bean/SocializeEntity;)V
    ...
    .line 84
    iput-object p1, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;

    .line 86
    iget-object v0, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;

    sget-object v1, Lcom/umeng/socialize/controller/b$a;->b:Lcom/umeng/socialize/controller/b$a;

    new-array v2, v4, [Ljava/lang/Object;

    invoke-static {v0, v1, v2}, Lcom/umeng/socialize/controller/b;->a(Lcom/umeng/socialize/bean/SocializeEntity;Lcom/umeng/socialize/controller/b$a;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/umeng/socialize/controller/CommentService;

    iput-object v0, p0, Lcom/umeng/socialize/controller/impl/BaseController;->c:Lcom/umeng/socialize/controller/CommentService;
    ...
    iput-object v0, p0, Lcom/umeng/socialize/controller/impl/BaseController;->d:Lcom/umeng/socialize/controller/LikeService;
    ...
    iput-object v0, p0, Lcom/umeng/socialize/controller/impl/BaseController;->e:Lcom/umeng/socialize/controller/AuthService;
    ...
    iput-object v0, p0, Lcom/umeng/socialize/controller/impl/BaseController;->b:Lcom/umeng/socialize/controller/ShareService;
    ...
    iget-object v3, p0, Lcom/umeng/socialize/controller/impl/BaseController;->e:Lcom/umeng/socialize/controller/AuthService;
    ...
    iput-object v0, p0, Lcom/umeng/socialize/controller/impl/BaseController;->f:Lcom/umeng/socialize/controller/UserCenterService;
...
.method protected a(Landroid/content/Context;)Z
    ...
    .line 111
    invoke-virtual {p0, p1}, Lcom/umeng/socialize/controller/impl/BaseController;->actionBarInit(Landroid/content/Context;)I
...
.method public actionBarInit(Landroid/content/Context;)I
    ...
    .line 125
    sget v0, Lcom/umeng/socialize/controller/impl/BaseController;->g:I
    ...
    iget-object v5, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;
    ...
    .line 148
    sget v3, Lcom/umeng/socialize/controller/impl/BaseController;->g:I
    ...
    sput v4, Lcom/umeng/socialize/controller/impl/BaseController;->g:I
    ...
    .line 177
    :cond_4
    iget-object v3, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;

    monitor-enter v3

    .line 178
    :try_start_3
    iget-object v4, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;
    ...
    .line 184
    :goto_1
    iget-object v1, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;

    invoke-virtual {v1, v2}, Lcom/umeng/socialize/bean/SocializeEntity;->setNew(Z)V

    .line 185
    iget-object v2, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;
...
.method public varargs follow(Landroid/content/Context;Lcom/umeng/socialize/bean/SNSPair;[Ljava/lang/String;)Lcom/umeng/socialize/bean/MultiStatus;
    ...
    .line 265
    :cond_1
    new-instance v0, Lcom/umeng/socialize/net/m;

    iget-object v1, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;

    invoke-direct {v0, p1, v1, p2, p3}, Lcom/umeng/socialize/net/m;-><init>(Landroid/content/Context;Lcom/umeng/socialize/bean/SocializeEntity;Lcom/umeng/socialize/bean/SNSPair;[Ljava/lang/String;)V
    ...
    iget v2, v0, Lcom/umeng/socialize/net/n;->mStCode:I

    invoke-direct {v1, v2}, Lcom/umeng/socialize/bean/MultiStatus;-><init>(I)V

    .line 274
    iget-object v0, v0, Lcom/umeng/socialize/net/n;->a:Ljava/util/Map;
...
.method public getFriends(Landroid/content/Context;Lcom/umeng/socialize/bean/SHARE_MEDIA;Ljava/lang/String;)Lcom/umeng/socialize/net/l;
    .locals 3
    ...
    invoke-direct {v1, p1, v2, p2, p3}, Lcom/umeng/socialize/net/k;-><init>(Landroid/content/Context;Lcom/umeng/socialize/bean/SocializeEntity;Lcom/umeng/socialize/bean/SHARE_MEDIA;Ljava/lang/String;)V
    ...
    .line 223
    :cond_0
    iget v1, v0, Lcom/umeng/socialize/net/l;->mStCode:I
    ...
    iget v2, v0, Lcom/umeng/socialize/net/l;->mStCode:I

    iget-object v0, v0, Lcom/umeng/socialize/net/l;->mMsg:Ljava/lang/String;
    ...
    .line 227
    :cond_1
    iget-object v1, v0, Lcom/umeng/socialize/net/l;->a:Ljava/util/List;
...
.method public getPlatformInfo(Landroid/content/Context;Lcom/umeng/socialize/bean/SNSPair;)Lcom/umeng/socialize/net/y;
    .locals 3
    ...
    new-instance v1, Lcom/umeng/socialize/net/x;

    iget-object v2, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;

    invoke-direct {v1, p1, v2, p2}, Lcom/umeng/socialize/net/x;-><init>(Landroid/content/Context;Lcom/umeng/socialize/bean/SocializeEntity;Lcom/umeng/socialize/bean/SNSPair;)V
    ...
    check-cast v0, Lcom/umeng/socialize/net/y;

    .line 284
    return-object v0
.end method

.method public getPlatformKeys(Landroid/content/Context;)Lcom/umeng/socialize/net/GetPlatformKeyResponse;
    .locals 3
...
.method public getUserInfo(Landroid/content/Context;)Lcom/umeng/socialize/net/i;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/umeng/socialize/exception/SocializeException;
    ...
    invoke-direct {v1, p1, v2}, Lcom/umeng/socialize/net/h;-><init>(Landroid/content/Context;Lcom/umeng/socialize/bean/SocializeEntity;)V
    ...
    .line 252
    :cond_0
    iget v1, v0, Lcom/umeng/socialize/net/i;->mStCode:I
    ...
    iget v2, v0, Lcom/umeng/socialize/net/i;->mStCode:I

    iget-object v0, v0, Lcom/umeng/socialize/net/i;->mMsg:Ljava/lang/String;
...
.method public uploadImage(Landroid/content/Context;Lcom/umeng/socialize/media/UMediaObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v1, Lcom/umeng/socialize/net/v;

    iget-object v2, p0, Lcom/umeng/socialize/controller/impl/BaseController;->a:Lcom/umeng/socialize/bean/SocializeEntity;

    invoke-direct {v1, p1, v2, p2, p3}, Lcom/umeng/socialize/net/v;-><init>(Landroid/content/Context;Lcom/umeng/socialize/bean/SocializeEntity;Lcom/umeng/socialize/media/UMediaObject;Ljava/lang/String;)V
    ...
    check-cast v0, Lcom/umeng/socialize/net/w;

    .line 328
    if-eqz v0, :cond_0

    .line 329
    iget-object v0, v0, Lcom/umeng/socialize/net/w;->a:Ljava/lang/String;
...
.method public uploadKeySecret(Landroid/content/Context;)I
    ...
    invoke-direct {v1, p1, v2}, Lcom/umeng/socialize/net/t;-><init>(Landroid/content/Context;Lcom/umeng/socialize/bean/SocializeEntity;)V
    ...
    .line 353
    iget v0, v0, Lcom/umeng/socialize/net/u;->mStCode:I
...
.method public uploadPlatformToken(Landroid/content/Context;Lcom/umeng/socialize/bean/UMToken;)I
    ...
    .prologue
    .line 308
    iget-object v0, p0, Lcom/umeng/socialize/controller/impl/BaseController;->e:Lcom/umeng/socialize/controller/AuthService;
...
.method public uploadStatisticsData(Landroid/content/Context;)I
    ...
    invoke-direct {v1, p1, v2}, Lcom/umeng/socialize/net/r;-><init>(Landroid/content/Context;Lcom/umeng/socialize/bean/SocializeEntity;)V
    ...
    .line 344
    iget v0, v0, Lcom/umeng/socialize/net/s;->mStCode:I
